...
typedef struct oldValues {  /* Used in monitor() and monitorStatus() */
    ...
    epicsEnum16 tb6;        /* Trace user1 */
    epicsEnum16 tb7;        /* Trace user2 */
...
static long special(struct dbAddr * paddr, int after)
{
    ...
    case asynRecordTB7:
        traceMask = (pasynRec->tb0 ? ASYN_TRACE_ERROR : 0) |
                    ...
                    (pasynRec->tb5 ? ASYN_TRACE_USER1 : 0) |
                    (pasynRec->tb6 ? ASYN_TRACE_USER2 : 0);
...
static void monitorStatus(asynRecord * pasynRec)
{
    ...
    pasynRec->tb6 = (traceMask & ASYN_TRACE_USER1) ? 1 : 0;
    pasynRec->tb7 = (traceMask & ASYN_TRACE_USER2) ? 1 : 0;
